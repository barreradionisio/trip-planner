...
function PagoContent() {
  ...
  const [precioHotel, setPrecioHotel] = useState(0);
            ...
            <div className="pago-sidebar-mobile">
              <div style={{ background: "#fff", borderRadius: "13px", border: "1.5px solid #e8edf8", overflow: "hidden" }}>
                <div style={{ padding: "10px 14px", background: "#0D0C56", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  ...
                  <div style={{ fontFamily: "sans-serif", fontWeight: "800", fontSize: "16px", color: "#fff" }}>{totalMostrar}</div>
                </div>
          ...
          <div className="pago-sidebar">
            <div style={{ background: "#fff", borderRadius: "13px", border: "1.5px solid #e8edf8", overflow: "hidden", marginBottom: "12px" }}>
              ...
              <div style={{ background: "#1667E6", padding: "11px 14px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <div style={{ fontFamily: "sans-serif", fontWeight: "800", fontSize: "18px", color: "#fff" }}>{totalMostrar}</div>
              </div>
            </div>
