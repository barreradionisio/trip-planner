...
export default function EditarItinerario() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", fontFamily: "'Montserrat',sans-serif", background: "#f5f7ff" }}>
      ...
      {/* BODY */}
      <div style={{ maxWidth: "900px", margin: "0 auto", padding: "0 20px 40px", width: "100%", display: "grid", gridTemplateColumns: "200px 1fr", gap: "20px" }}>
            ...
            <div style={{ padding: "8px" }}>
              {itinerario.map(c => (
                <button
                  ...
                  style={{ width: "100%", padding: "10px 12px", border: "none", borderRadius: "8px", background: ciudadActiva === c.ciudad ? "#f0f5ff" : "transparent", color: ciudadActiva === c.ciudad ? "#1667E6" : "#0D0C56", fontWeight: ciudadActiva === c.ciudad ? "700" : "600", fontSize: "12px", cursor: "pointer", textAlign: "left", display: "flex", justifyContent: "space-between" }}
                >
                  {c.ciudad}
            ...
            <div style={{ padding: "8px" }}>
              {ciudadData.dias.map(d => (
                <button
                  ...
                  style={{ width: "100%", padding: "10px 12px", border: "none", borderRadius: "8px", background: diaActivo === d.dia ? "#f0f5ff" : "transparent", color: diaActivo === d.dia ? "#1667E6" : "#0D0C56", fontWeight: diaActivo === d.dia ? "700" : "600", fontSize: "12px", cursor: "pointer", textAlign: "left", display: "flex", justifyContent: "space-between" }}
                >
                  <span>Día {d.dia}</span>
          ...
          <div style={{ background: "#fff", borderRadius: "13px", border: "1.5px solid #e8edf8", overflow: "hidden" }}>
            <div style={{ padding: "14px 18px", borderBottom: "1px solid #f0f2fa", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <button
                ...
                style={{ padding: "8px 16px", background: "#1667E6", color: "#fff", border: "none", borderRadius: "8px", fontSize: "12px", fontWeight: "700", cursor: "pointer" }}
              >
                + Agregar actividad
              </button>
            </div>
            ...
            {agregando && (
              <div style={{ padding: "14px 18px", background: "#f0f5ff", borderBottom: "1px solid #e0eaff" }}>
                ...
                <div style={{ display: "flex", gap: "8px" }}>
                  <button onClick={agregarActividad} style={{ padding: "8px 20px", background: "#FF5C00", color: "#fff", border: "none", borderRadius: "8px", fontSize: "12px", fontWeight: "700", cursor: "pointer" }}>Agregar</button>
                  <button onClick={() => setAgregando(false)} style={{ padding: "8px 16px", background: "#fff", color: "#888", border: "1.5px solid #e8edf8", borderRadius: "8px", fontSize: "12px", fontWeight: "600", cursor: "pointer" }}>Cancelar</button>
                </div>
              </div>
            )}
                    ...
                    <div key={a.id} style={{ display: "flex", gap: "12px", alignItems: "flex-start" }}>
                      ...
                      <div style={{ flex: 1, background: tipo.bg, borderRadius: "10px", padding: "12px 14px", border: `1px solid ${tipo.color}20` }}>
                        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "4px" }}>
                          ...
                          <span style={{ fontSize: "10px", background: "#fff", color: tipo.color, padding: "2px 8px", borderRadius: "50px", fontWeight: "600", border: `1px solid ${tipo.color}30`, marginLeft: "auto" }}>{a.tipo}</span>
                        </div>
                        <div style={{ fontSize: "12px", color: "#666" }}>{a.desc}</div>
                      </div>
                      <button
                        onClick={() => eliminarActividad(a.id)}
                        style={{ width: "32px", height: "32px", borderRadius: "50%", border: "1.5px solid #ffd0d0", background: "#ffeaea", color: "#c0392b", fontSize: "16px", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, marginTop: "8px" }}
                      >×</button>
                    </div>
                  );
                })
            ...
            <div style={{ padding: "14px 18px", borderTop: "1px solid #f0f2fa", display: "flex", justifyContent: "flex-end", gap: "10px" }}>
              ...
              <button onClick={guardar} style={{ padding: "10px 24px", background: guardado ? "#3ED5A9" : "#FF5C00", color: "#fff", border: "none", borderRadius: "8px", fontSize: "12px", fontWeight: "700", cursor: "pointer", transition: "background 0.3s" }}>
