    ...
    <>
      <style>{`
        * { box-sizing: border-box; }
        ...
        .conf-nav-links { display: flex; gap: 28px; align-items: center; }
        .conf-content {
          max-width: 800px;
          margin: 0 auto;
          padding: 28px 20px;
        ...
        @media (max-width: 768px) {
          .conf-nav { padding: 12px 16px; }
          .conf-nav-links { display: none; }
          .conf-content { padding: 16px; }
          .conf-acciones { grid-template-columns: 1fr; }
          .conf-resumen-grid { grid-template-columns: 1fr; }
      ...
      <div className="conf-wrap">
        ...
        <div style={{ background: "linear-gradient(135deg,#085041,#3ED5A9)", padding: "48px 24px", textAlign: "center" }}>
          ...
          <h1 style={{ fontFamily: "sans-serif", fontWeight: "800", fontSize: "28px", color: "#fff", marginBottom: "8px" }}>¡Reserva confirmada!</h1>
        ...
        <div className="conf-content">
          ...
          <div className="conf-acciones">
            ...
            <Link href="/mis-viajes/documentos" style={{ background: "#fff", borderRadius: "13px", border: "1.5px solid #e8edf8", padding: "16px", textAlign: "center", textDecoration: "none", display: "block" }}>
              ...
              <div style={{ fontSize: "12px", fontWeight: "700", color: "#1667E6", marginTop: "2px" }}>Itinerario (PDF)</div>
            </Link>
          ...
          <div style={{ background: "#fff", borderRadius: "13px", border: "1.5px solid #e8edf8", overflow: "hidden", marginBottom: "16px" }}>
            ...
            <div style={{ padding: "16px 18px" }}>
              <div className="conf-resumen-grid">
          ...
          <div style={{ background: "#fff8e0", border: "1.5px solid #F5A623", borderRadius: "13px", padding: "14px 18px", marginBottom: "24px" }}>
            <div style={{ display: "flex", alignItems: "flex-start", gap: "8px" }}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#7a4800" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, marginTop: "1px" }}>
                <path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/>
                <line x1="12" y1="9" x2="12" y2="13"/>
                <line x1="12" y1="17" x2="12.01" y2="17"/>
              </svg>
              <div>
                <div style={{ fontWeight: "700", fontSize: "12px", color: "#7a4800", marginBottom: "4px" }}>Política de cancelación</div>
                <div style={{ fontSize: "11px", color: "#7a4800", lineHeight: "1.6" }}>
                  Las condiciones dependen de la tarifa contratada. Consulta en <strong>Mis viajes</strong> o escríbenos a <strong>soporte@tripplanner.com.mx</strong>
                </div>
              </div>
            </div>
          </div>
